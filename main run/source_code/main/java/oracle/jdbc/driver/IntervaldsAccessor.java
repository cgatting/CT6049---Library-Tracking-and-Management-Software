...
extends Accessor {
    ...
    IntervaldsAccessor(OracleStatement oracleStatement, int n2, short s2, int n3, boolean bl) throws SQLException {
        super(Representation.INTERVALDS, oracleStatement, 11, bl);
        this.init(oracleStatement, 183, 183, s2, bl);
        this.initForDataAccess(n3, n2, null);
    }

    IntervaldsAccessor(OracleStatement oracleStatement, int n2, boolean bl, int n3, int n4, int n5, long l2, int n6, short s2) throws SQLException {
        super(Representation.INTERVALDS, oracleStatement, 11, false);
        this.init(oracleStatement, 183, 183, s2, false);
        this.initForDescribe(183, n2, bl, n3, n4, n5, l2, n6, s2, null);
