...
implements Monitor {
    ...
    NTFDCNConnection(String string, ArrayList<String> arrayList, String string2, String string3, String string4, OpaqueString opaqueString, Properties properties, String string5, int n2) {
    ...
    public void run() {
        ...
        for (int i2 = 0; i2 < 2 && !this.needToBeClosed; ++i2) {
            try {
                ...
                if (this.needToBeClosed || bl) break;
